document.addEventListener('DOMContentLoaded', function() {	
	...
	if (urlParams.get('sucesso') === 'true') {
        // NOVO: Verifica se o backend mandou um novo usuário ajustado
        const userGerado = urlParams.get('userGerado');
        
        if (userGerado) {
            Swal.fire({
                title: 'Cadastrado com Ajuste',
                html: `O cadastro foi realizado, mas o usuário de login foi ajustado para <b>${userGerado}</b> pois o nome sugerido já estava em uso.`,
                icon: 'success',
