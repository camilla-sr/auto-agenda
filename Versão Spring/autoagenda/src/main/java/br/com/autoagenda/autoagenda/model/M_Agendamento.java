...
import br.com.autoagenda.autoagenda.model.M_AuxiliarProdutosUsados;

public class M_Agendamento {
	final Conexao conn = new Conexao();
    M_AuxiliarProdutosUsados au = new M_AuxiliarProdutosUsados();
    ...
    public void listaEdicao() {
        ...
        try {
            while (lista.next()) {
                ...
                String dataCadastro = Helper.dataPadraoBR(lista.getString("a.data_cadastro"));
                String dataPrevisao = Helper.dataPadraoBR(lista.getString("a.data_previsao_entrega"));
                if (lista.getString("a.data_conclusao") != null) {
                    dataConclusao = Helper.dataPadraoBR(lista.getString("a.data_conclusao"));
                } else {
