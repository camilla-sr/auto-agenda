...
public class M_Peca {
	private LocalDateTime agora = LocalDateTime.now(); // Retorna data e hora atuais com base no servidor
    private DateTimeFormatter formato = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
    private String dataHoje = agora.format(formato);
...
// -------------- MÉTODOS DE APOIO ---------------    
    ...
    public int getQntdPeca() { return qntdPeca; }
    public void setQntdPeca(int qntdPeca) { this.qntdPeca = qntdPeca; }
}
