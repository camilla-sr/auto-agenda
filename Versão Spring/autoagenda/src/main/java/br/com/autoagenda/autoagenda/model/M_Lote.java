...
public class M_Lote {
    ...
    public void listarLote() {
        ...
        try {
            if (lista != null) {
                while (lista.next()) {
                    String dataCompra = Helper.dataPadraoBR(lista.getString("data_compra"));
                    String dataVenci = Helper.dataPadraoBR(lista.getString("data_vencimento"));
    ...
    public void listaEdicao() {
        ...
        try {
            while (lista.next()) {
                ...
                String dataCompra = Helper.dataPadraoBR(lista.getString("lt.data_compra"));
